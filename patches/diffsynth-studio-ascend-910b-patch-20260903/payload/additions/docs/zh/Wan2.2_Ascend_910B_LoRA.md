...
上提供正确性优先的昇腾后端，本版本仅覆盖：

- `Wan-AI/Wan2.2-TI2V-5B` T2V
- `Wan-AI/Wan2.2-TI2V-5B` I2V
...
模型与任务、分辨率和帧数、LoRA rank、逐 step loss、显存峰值、step time 以及
checkpoint 加载/保存结果。
